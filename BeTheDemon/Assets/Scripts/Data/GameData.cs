...
public class GameData
{
    ...
    public void GameDataLoad(int language)
    {
        ...
        sheets = ec.GetSheetNameInExcel(@"Assets\ExcelFiles\StringInGame.xlsx");
        datas = ec.ImportExcelBySheet<UIDatas>(@"Assets\ExcelFiles\StringInGame.xlsx", sheets);
    }
    ...
    public List<ScrollStatData> InsertDataInCharacterMainStat()
    {
        ExcelDataFunc(0);
        List<ScrollStatData> list = new List<ScrollStatData>();
