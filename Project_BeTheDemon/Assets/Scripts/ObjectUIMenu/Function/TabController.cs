...
{
    [SerializeField] public bool AllowSwitchOff;// true(Create Faketab) : false(allways toggle 1)
    [SerializeField] public RectTransform ContentTabMenu;

    [SerializeField] public GameObject BaseItem;
    [SerializeField] public int tabAmount;
    [SerializeField] public RectOffset padding;
    [SerializeField] public float spacing;

    [SerializeField] public float tabMorphWidth;
    [SerializeField] public float tabMorphHeight;

    [SerializeField] public Sprite commonTabIdle;
    [SerializeField] public Sprite commonTabActive;
